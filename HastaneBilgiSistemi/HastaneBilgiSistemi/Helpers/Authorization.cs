...
namespace HastaneBilgiSistemi.Helpers
{
    ...
    public class AuthorizeTagHelper : TagHelper, IAuthorizeData
    {
        ...
        /// <summary>
        /// Gets or sets a comma delimited list of roles that are not allowed to access the HTML  block.
        /// </summary>
        [HtmlAttributeName("asp-reverse")]
